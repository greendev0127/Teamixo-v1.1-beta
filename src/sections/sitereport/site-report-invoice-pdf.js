...
export default function InvoicePDF({ invoice, selectService, staffs }) {
  // const {
  //   items,
  //   taxes,
  //   dueDate,
          ...
          <View>
            <View style={styles.tableRow}>
              ...
              <View style={[styles.tableCell_3, styles.alignRight]}>
                <Text style={styles.subtitle2}>Total price</Text>
              </View>
            </View>
          </View>
