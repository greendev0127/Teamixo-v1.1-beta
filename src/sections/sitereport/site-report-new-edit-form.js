...
export default function TourNewEditForm({ currentReport }) {
  ...
  const defaultValues = useMemo(
    () => ({
      ...
      //
      available: {
        startDate: currentReport?.available.startDate || null,
        breakDate: currentReport?.available.breakDate || null,
        restartDate: currentReport?.available.restartDate || null,
        endDate: currentReport?.available.endDate || null,
      },
    }),
    [currentReport]
  );
